...
<head>
  ...
  <meta name="apple-mobile-web-app-status-bar-style" content="#FF396F">
    ...
    <!-- Favicons -->
  <link rel="shortcut icon" href="'.$base_url.'/sw-content/univ.jpg">
  <link rel="apple-touch-icon" href="'.$base_url.'/sw-content/univ.jpg">
  <link rel="apple-touch-icon" sizes="72x72" href="'.$base_url.'/sw-content/univ.jpg">
  <link rel="apple-touch-icon" sizes="114x114" href="'.$base_url.'/sw-content/univ.jpg">
