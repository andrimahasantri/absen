...
<!-- /.login-box -->'; ?>
  ...
  <footer class="text-muted text-center">
    <small></span><span id="credits"><a class="credits" href="https://darunnajah.ac.id" target="_blank">Universitas Darunnajahr</a> - Absensi</span>
      <em>Universitas Darunnajah</em></small>
  </footer>
