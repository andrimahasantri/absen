<?php if (empty($connection)) {
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">Theme LTE / 
     ...
     &copy;' . DATE('Y') . ' ' . $site_name . ' | Design With BPTI <i class="fa fa-heart"></i> From <a class="credits" href="https://darunnajah.ac.id" id="credits" title="Universitas Darunnajah">UNIVERSITAS DARUNNAJAH</a> - Absensi
  </footer>
</div>
<!-- wrapper -->
